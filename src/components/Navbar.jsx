...
const Navbar = () => {
  const navLinkClass = ({ isActive }) =>
    `flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-100 md:flex-row md:justify-center ${
    ...
    <nav className={navClasses}>
      <div className="flex justify-around items-center h-16 md:h-auto md:flex-col md:items-stretch md:space-y-6">
        <NavLink to="/" className={navLinkClass}>
          ...
          <span className={'text-xs mt-1 md:hidden'}>الامتحانات</span>
        </NavLink>
        <NavLink to="/evaluations" className={navLinkClass}>
            ...
            <span className={'text-xs mt-1 md:hidden'}>التقييمات</span>
        </NavLink>
        <NavLink to="/leaderboard" className={`${navLinkClass} hidden md:flex`}>
            ...
            <span className={'text-xs mt-1 md:hidden'}>المتصدرين</span>
        </NavLink>
        <NavLink to="/store" className={navLinkClass}>
            ...
            <span className={'text-xs mt-1 md:hidden'}>المتجر</span>
        </NavLink>
        <NavLink to="/profile" className={navLinkClass}>
            ...
            <span className={'text-xs mt-1 md:hidden'}>الملف الشخصي</span>
        </NavLink>
      </div>
    </nav>
  );
